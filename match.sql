...
update sites_locations a, locations b, surfaces s set a.surface_id=s.id 
where a.loc_id_1=b.id and position(a.surface in s.name)<>0 and s.id is not null and a.surface<>"" and a.site in("alliancehockey", "omha-aaa", "tcmhl");
