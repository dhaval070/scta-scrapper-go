SELECT e.surface_id, l.name location_name, s.name surface_name, date_format(e.datetime, "%W") dow, min(e.datetime) start_time, max( date_add(e.datetime, INTERVAL 90 minute)) end_time
FROM
