...
func main() {
	...
	doc, err = htmlquery.LoadURL("https://intertownll.ca/Seasons/Current/")

	groups := parseGroups(doc)
	log.Println(groups)

	var result = parser.FetchSchedules(SITE, "https://intertownll.ca/", "https://intertownll.ca/Groups/%s/Calendar/?Month=%d&Year=%d", groups, mm, yyyy)
