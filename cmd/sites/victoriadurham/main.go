...
func main() {
	...
	doc, err = htmlquery.LoadURL("https://victoriadurham.ca/Seasons/Current/")

	groups := parseGroups(doc)
	log.Println(groups)

	var result = parser.FetchSchedules(SITE, "https://victoriadurham.ca/", "https://victoriadurham.ca/Groups/%s/Calendar/?Month=%d&Year=%d", groups, mm, yyyy)
