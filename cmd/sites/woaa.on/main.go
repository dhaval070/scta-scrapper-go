...
func main() {
	...
	doc, err = htmlquery.LoadURL("https://woaa.on.ca/Leagues/1000/Seasons/Current/")

	groups := parseGroups(doc)
	log.Println(groups)

	var result = parser.FetchSchedules(SITE, "https://woaa.on.ca/", "https://woaa.on.ca/Groups/%s/Calendar/?Month=%d&Year=%d", groups, mm, yyyy)
