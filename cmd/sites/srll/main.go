...
func main() {
	...
	doc, err = htmlquery.LoadURL("https://srll.ca/Seasons/Current/")

	groups := parseGroups(doc)
	log.Println(groups)

	var result = parser.FetchSchedules(SITE, "https://srll.ca/", "https://srll.ca/Groups/%s/Calendar/?Month=%d&Year=%d", groups, mm, yyyy)
