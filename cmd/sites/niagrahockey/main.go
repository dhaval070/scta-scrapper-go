...
func main() {
	...
	doc, err = htmlquery.LoadURL("https://niagaradistricthockeyleague.com/Seasons/Current/")

	groups := parseGroups(doc)
	log.Println(groups)

	var result = parser.FetchSchedules(SITE, "https://niagaradistricthockeyleague.com/", "https://niagaradistricthockeyleague.com/Groups/%s/Calendar/?Month=%d&Year=%d", groups, mm, yyyy)
